...
export default function CategoryCard({ title, description, icon, onClick }) {
  return (
    <div
      onClick={onClick}
      // Card Styling: Warm White background, Soft Cyan border, Deep Shadow
      className="cursor-pointer bg-white/90 border-b-8 border-cyan-400 rounded-3xl p-6 shadow-2xl shadow-indigo-300/70 
                 max-w-xs w-full text-center 
                 transform transition-all duration-300 ease-in-out 
                 hover:scale-105 hover:shadow-3xl hover:border-cyan-300 active:scale-100"
    >
      
      <div className="mb-4 text-7xl text-indigo-700">
        {icon}
      </div>
